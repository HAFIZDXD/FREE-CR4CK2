...
print("➤ follow FB gw dulu cuy")
os.system("xdg-open https://www.facebook.com/hadzd.channel?text=Hallo%20Bang%20Ganteng")
...
bahasa = "en-GB,q=0.8"
#id-ID,id;q=0.9,en-US;q=0.8,e=0.7
###########################################################################################
...
def license():#line:42
  try :#line:43
    ...
    os .system ('clear')
    print (f"""
[{H}1{U}]{H} Beli License
[{H}2{U}]{H} Masukan License
""")#line:49
    OOO00O0OOO00OO00O =input (f"{H}[{H}?{H}]{H} Choose :{K} ")#line:50
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{H}!{H}]{H} Send Message..");time .sleep (3 );os .system ('xdg-open wa.me/6285758862225/?text=Mas+Saya+Mau+Beli+License');exit ()#line:52
    elif OOO00O0OOO00OO00O in ['2','02']:#line:53
      O000O000OOO000OOO =input (f"{H}[?{H}] Api Key :{K} ")#line:54
    ...
    exit (f"[{H}!]{h} Api Key Invalid")#line:67
  except Exception as O0OO00OOO000OOO00 :#line:68
    exit (f"[{H}!]{H} {O0OO00OOO000OOO00}")#line:69
# CLEAR
def clear():
	os.system('clear')
# BACK
